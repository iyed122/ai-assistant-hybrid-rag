export default function Header({ theme, onToggleTheme, onToggleSidebar, sidebarOpen, mode, onToggleMode, onSetMode }) {
  return (
    <div className="header">
      <div className="header-left">
        ...
        <span className="header-title">AI <span>Assistant</span></span>

        {/* Mode switcher — sits next to the title */}
        <div className="mode-switcher">
          ...
          <button
            ...
            title="Training pipeline + MLflow"
          >
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
